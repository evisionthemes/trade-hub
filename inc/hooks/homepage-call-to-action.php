...
/**
	...
	*/
	function trade_hub_call_to_action()
	{
		...
		$trade_hub_call_action_main_text = $trade_hub_customizer_all_values['trade-hub-call-action-main-text'];
		$trade_hub_call_action_button_text = $trade_hub_customizer_all_values['trade-hub-call-action-button-text'];
...
add_action('trade_hub_homepage','trade_hub_call_to_action',40);