...
if ( ! function_exists( 'trade_hub_home_feature_array' ) ) :
    ...
    function trade_hub_home_feature_array(  ){
        ...
        if( !empty( $trade_hub_home_feature_args ))
        {
            ...
            if ( $trade_hub_home_feature_post_query->have_posts() ) :
                ...
                while ( $trade_hub_home_feature_post_query->have_posts() ) : $trade_hub_home_feature_post_query->the_post();
                    ...
                    if (has_excerpt())
                    {
                        $trade_hub_home_feature_contents_array[$i]['trade-hub-home-feature-content'] = get_the_excerpt();
                    }
                    else
                    {
                        $trade_hub_home_feature_contents_array[$i]['trade-hub-home-feature-content'] = trade_hub_words_count( $trade_hub_home_feature_single_words ,get_the_content());
                    }
                    $trade_hub_home_feature_contents_array[$i]['trade-hub-home-feature-link'] = get_permalink();
                    if(isset( $trade_hub_icons_arrays[$i] ))
                    {
                        $trade_hub_home_feature_contents_array[$i]['trade-hub-home-feature-page-icon'] = $trade_hub_icons_arrays[$i]['trade-hub-home-feature-page-icon'];
                    }
                    else
                    {
        ...
        // var_dump($trade_hub_home_feature_contents_array);
