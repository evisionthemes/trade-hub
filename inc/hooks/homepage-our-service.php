...
if ( !function_exists('trade_hub_our_service') ) :
	...
	*/
 	function  trade_hub_our_service()
 	{
 		...
 		$trade_hub_our_service_sub_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-sub-title']);
 		$trade_hub_our_service_first_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-first-title']);
 		$trade_hub_our_service_first_sub_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-first-sub-title']);
 		$trade_hub_our_service_second_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-second-title']);
 		$trade_hub_our_service_second_sub_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-second-sub-title']);
 		$trade_hub_our_service_third_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-third-title']);
 		$trade_hub_our_service_third_sub_title = esc_html__($trade_hub_customizer_all_values['trade-hub-our-service-third-sub-title']);
